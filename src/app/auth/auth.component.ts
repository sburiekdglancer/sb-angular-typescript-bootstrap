...
export class AuthComponent implements OnInit {
    ...
    @ViewChild('alertSignin',
        <any>{ read: ViewContainerRef }) alertSignin: ViewContainerRef;
    @ViewChild('alertSignup',
        <any>{ read: ViewContainerRef }) alertSignup: ViewContainerRef;
    @ViewChild('alertForgotPass',
        <any>{ read: ViewContainerRef }) alertForgotPass: ViewContainerRef;
